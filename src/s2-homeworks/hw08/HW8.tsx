...
const initialPeople: UserType[] = [
    ...
    {_id: 0, name: 'Тимошин Роман', age: 3},
    {_id: 1, name: 'Бориславов Макс', age: 66},
    {_id: 2, name: 'Аладинов Антон', age: 16},
    {_id: 3, name: 'Макаров Михаил', age: 44},
    {_id: 4, name: 'Костюшкиг Дмитрий', age: 40},
    {_id: 5, name: 'Билык Ирина', age: 55},
]
